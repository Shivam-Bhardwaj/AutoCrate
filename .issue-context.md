...
| ------------------------- | --------------- | --------- | ------------------------------------------------------------- |
| 2025-10-23T21:13:49+00:00 | Shivam Bhardwaj | `3ca71cf` | fix: keep change tracker issue link (#147)                    |
| 2025-10-20T12:38:46-07:00 | Shivam Bhardwaj | `852dd8c` | Fix: Make middleware Edge Runtime compatible                  |
| 2025-10-20T12:34:15-07:00 | Shivam Bhardwaj | `07819e9` | chore: Force Vercel rebuild to clear cache                    |
| 2025-10-20T12:33:21-07:00 | Shivam Bhardwaj | `59ebd9a` | test: Update panel stop tests for new centering logic         |
| 2025-10-20T12:23:13-07:00 | Shivam Bhardwaj | `ee375dd` | Fix: Panel stops now centered vertically on front panel (#93) |
...
- Completed: All 21 panel stop tests passing
- Pending: Visual inspection: Panel stops visible on front panel left/right edges
- Pending: Visual inspection: Top panel stop visible on front edge
- Pending: No interference with cleats or klimps
- Pending: Test crates: 24x24x24, 48x48x48, 96x72x60
...
- Completed: All lag screw tests passing
- Pending: Small crate (24x24x24): 2 lags at ends only
- Pending: Medium crate (48x48x48): 3 lags (start, middle, end), spacing ~24"
- Pending: Large crate (96x72x60): Front ~96" has 5 lags, spacing ~24"
- Pending: All panels have lags on all edges
- Pending: No missing lags on end panels
...
- Completed: All panel stop tests passing with new clearance
- Pending: Visual inspection: 4" gap between side panels and ground
- Pending: Configuration slider changes clearance in real-time
- Pending: Forklift accessibility: Standard 2" forks + clearance
- Pending: Test with custom clearance values (2", 6", 8")
...
- Pending: NX export file downloads correctly
- Pending: Coordinate system documentation clear and complete
- Pending: Datum planes: XY at Z=0, YZ at X=0, XZ at Y=0
- Pending: Import into NX CAD (if available) and verify datum alignment
- Pending: Manufacturing drawings reference correct datums
...
- Pending: Toggle panel stops visibility - verify 3 stops render
- Pending: Toggle lag screws visibility - verify all panels have lags
- Pending: Check side panel positioning - 4" gap from ground visible
- Pending: Rotate view to inspect all edges
- Pending: No z-fighting or overlapping components

**STEP Export:**

- Pending: Download STEP file
- Pending: Open in CAD software (eDrawings, FreeCAD, etc.)
- Pending: Verify panel stop positions (1.0625" from edges)
- Pending: Verify lag screws present on all panels
- Pending: Verify 4" ground clearance
- Pending: Check datum planes at Z=0, X=0, Y=0

**NX Export:**

- Pending: Download NX expressions file
- Pending: Verify coordinate system documentation
- Pending: Verify datum plane references
- Pending: Check all measurements in inches
- Pending: Verify expression names follow NX conventions
...
- Pending: Skids position correctly
- Pending: Floorboards generate properly
- Pending: Klimp fasteners visible on front panel
- Pending: Cleats positioned on all panels
- Pending: Plywood pieces render correctly
- Pending: Panel splice visualizations work
- Pending: Cut list displays properly
- Pending: BOM generates correctly
...
- Pending: Side panel ground clearance (0" - 8")
- Pending: Lag screw spacing (18" - 24")
- Pending: Panel thickness changes
- Pending: Lumber size restrictions
- Pending: Clearance adjustments (side, end, top)
...
- Pending: All unit tests passing
- Pending: All E2E tests passing
- Pending: Visual testing complete for all 3 test crate sizes
- Pending: STEP export verified in CAD software
- Pending: NX export file format validated
- Pending: Documentation updated
- Pending: No console errors in browser
- Pending: Mobile responsiveness maintained
- Pending: Performance acceptable (< 2s initial load)
